...
const PledgeManagerSalesExecutive = () => {
  ...
  const fetchPledges = async (page = 1, pageSize = 10) => {
    try {
      setLoading(true);
      const response = await pledgeService.getAllManagerPledges1(page, pageSize);
  ...
  return (
    <div style={{ padding: '24px', backgroundColor: roots.background.default, minHeight: '100vh' }}>
      ...
      <Modal
        title="New Quotation Generated Send To Regional Manager"
...
export default PledgeManagerSalesExecutive;
